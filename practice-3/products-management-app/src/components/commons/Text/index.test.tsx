...
describe('Button component', () => {
  ...
  test('should render correctly', () => {
    const defaultText = create(<Text>Typography</Text>).toJSON();
    ...
    const boldText = create(<Text fw={FwType.Bold}>Typography</Text>);
    expect(boldText).toMatchSnapshot();

    const italicText = create(<Text fs={FsType.Italic}>Typography</Text>);
